...
cust_raw_pss    equ raw_drv+1       ; $ed01
cust_raw_nps    equ raw_pss+1       ; $ed02
cust_raw_npt    equ raw_nps+1       ; $ed03
cust_raw_dsf    equ raw_npt+1       ; $ed04
cust_raw_flg    equ raw_dsf+1       ; $ed05
cust_raw_wkspc  equ raw_flg+1       ; $ed06
cust_raw_lpsmap equ raw_wkspc+2     ; $ed08
...
f_dmaoff        equ 1ah
    ...
    INC         HL                                      
    LD          (HL),0x56                 
LAB_ram_0119:                 ;XREF[1,0]:   ram:010e
    LD          DE,fcb
    LD          A,0x0                                   
    LD          (007ch),A                        
    LD          C,f_open
    ...
    LD          HL,line_buffer
    LD          (line_ptr),HL                       
LAB_ram_0130:                 ;XREF[1,0]:   ram:0145
    PUSH        HL
    EX          DE,HL                                   
    LD          C,f_dmaoff
    CALL        bdos                                    
    ...
    LD          HL,0xff                                 
    LD          (dpb_dsm),HL                       
    CALL        parse_word_value                            ;undefined parse_word_value()
    LD          (dpb_drm),HL                       
    LD          HL,0x4                                  
    LD          (dpb_cks),HL                       
    CALL        parse_word_value                            ;undefined parse_word_value()
    ...
    CALL        parse_word_value                            ;undefined parse_word_value()
    LD          (dpb_off),HL                       
    CALL        parse_byte_value                            ;undefined parse_byte_value()
    CP          0x4                                     
    JP          NC,out_of_range                         
    CP          0x0                                     
    JP          Z,out_of_range                          
...
read_to_eol:
    ...
    LD          (line_ptr),HL                       
    RET                                                 
file_not_found:                 ;XREF[1,0]:   ram:0127
    LD          DE,err_filenotfound
print_and_exit:
    LD          C,c_writestr                                       ; c_writestr
    CALL        bdos                                    
    RST         0
invalid_number:                 ;XREF[2,0]:   ram:0219,ram:021e
...
end_of_file:
    ...
    JP          print_and_exit                            
err_filenotfound
    ds         "ERROR: File not found, aborted.\r\n$"
err_invalidnumber
    ds         "ERROR: Line contains invalid number\r\n$"
err_outofrange
    ds         "ERROR: Number is out of range\r\n$"
err_endoffile
    ds         "ERROR: Unexpected end of input file\r\n$"
success_message
    ds         "Drive G: has successfully been defined.\r\n$"
signon_message
    ds         "Raw disk read definer V1.0 by B. Watson\r\n"
...
default_definitions:
    ...
    db          07h,7Fh,0Fh                                     
line_ptr:
DAT_ram_037d:                 ;XREF[3,0]:   ram:012d,ram:0202,ram:024e
    defw        0
line_buffer:
DAT_ram_037f:                 ;XREF[1,0]:   ram:0130
    ??          00h                                     
